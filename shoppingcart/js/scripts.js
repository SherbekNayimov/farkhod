$(function () {
    ...
    $(".shopping_cart").click(function () {
        let data = {};
        $.post("http://robotics.uz/shoppingcart/shopping_cart.php", data, function (response) {
    ...
    $(document).on('click', '.remove_item_icon', function () {
        ...
        let result = null;
        $.post("http://robotics.uz/shoppingcart/delete_items.php", data, function (qty) {
            $.post("http://robotics.uz/shoppingcart/shopping_cart.php", data, function (response) {
                $("#modal_body").html(response);
    ...
    $(".product").click(function () {
        ...
        $.post("http://robotics.uz/shoppingcart/add_shopping_cart.php", data, function (qty) {
            $(".shopping_cart").text(qty);
        });
    })
});
